...
| tags                   | Tags are optional with any created post. Any new tag(s) will be shown in `yourdomain.com/posts` & `yourdomain.com/blog/tags`, and generate the page(s) `yourdomain.com/blog/tags/[yourTag]`                                                                                                                            |
